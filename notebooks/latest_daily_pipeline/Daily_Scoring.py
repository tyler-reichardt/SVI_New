...
df_scoring = scorer.load_training_data('daily_claims_svi')
...
df_scoring_spark.write.mode("overwrite").option("overwriteSchema", "true").saveAsTable(f"{env_config['mlstore_catalog']}.single_vehicle_incident_checks.daily_svi_predictions")

# COMMAND ----------

pd.set_option('display.max_columns', None)
display(df_scoring[sorted(df_scoring.columns)])
